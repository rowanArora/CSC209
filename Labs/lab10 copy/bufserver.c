...
int main() {
    ...
    while (1) {
        ...
        // Receive messages
        char buf[BUFSIZE] = {'\0'};
        int inbuf = 0;           // How many bytes currently in buffer?     0 bytes currently in buffer.
        int room = sizeof(buf);  // How many bytes remaining in buffer?     30 bytes remaining in buffer.
